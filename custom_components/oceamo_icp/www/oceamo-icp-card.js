...
const TEXT = {
  de: {
    ...
    correctionDose: "Korrekturdosis",
    reduceOrPause: "Keine Korrekturdosis. Diese Lösung vorerst reduzieren bzw. pausieren.",
    noCoreCorrection: "Für Calcium, Magnesium und KH ist anhand dieser Analyse keine Korrekturdosis nötig.",
    correctionOnly: "Die berechnete Menge ist eine Korrekturdosis auf Basis der Standard-Gebrauchslösung, keine tägliche Dauerdosierung. Die tägliche Balling-Light-Dosis richtet sich nach dem tatsächlichen Verbrauch.",
    tracePending: "Spurenelement-Korrekturen über Balling Trace / Elementals werden in dieser Stufe noch nicht automatisch berechnet.",
  ...
  en: {
    ...
    reduceOrPause: "No correction dose. Reduce or pause this solution for now.",
    noCoreCorrection: "No correction dose is required for calcium, magnesium or alkalinity based on this analysis.",
    correctionOnly: "The calculated amount is a correction dose using the standard working solution, not a permanent daily dose. Daily Balling Light dosing must follow actual consumption.",
    tracePending: "Trace-element corrections via Balling Trace / Elementals are not calculated automatically in this stage yet.",
    ...
    this.shadowRoot.innerHTML = `
      ...
      <ha-card>
        <div class="header">
          ...
          ${
            hasAquariumVolume || supplySystem
              ? `
                  ...
                  ${
                    supplyRecommendations.supported
                      ? `
                        ...
                        <div class="recommendation-note">
                          <ha-icon icon="mdi:flask-outline"></ha-icon>
                          <span>${escapeHtml(t.tracePending)}</span>
                        </div>
                      `
                      : `
                        <div class="recommendation-empty">
