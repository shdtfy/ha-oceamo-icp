...
const TEXT = {
  de: {
    ...
    noStatusChanges: "Keine Statusänderungen gegenüber der vorherigen ICP.",
    newIssue: "Neu auffällig",
    resolved: "Wieder OK",
    statusWorsened: "Status verschärft",
    statusImproved: "Status verbessert",
  ...
  en: {
    ...
    noStatusChanges: "No status changes compared with the previous ICP.",
    newIssue: "New issue",
    resolved: "Back to OK",
