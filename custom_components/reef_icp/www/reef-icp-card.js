...
const TEXT = {
  de: {
    ...
    noOdor: "Kein Geruch",
    noColor: "Keine Färbung",
    noDeterminedMeasurements: "In der bisherigen ICP-Historie wurde keiner dieser Werte bestimmt.",
    unknown: "Unbekannt",
    ...
    displaySections: "Zusatzbereiche",
    showActionPlan: "Maßnahmenplan anzeigen",
    showChanges: "Vergleich seit letzter ICP anzeigen",
    showProfileInsights: "Besatzprofil-Hinweise anzeigen",
    showLabRecommendations: "Labor-Empfehlungen anzeigen",
    showSupplyRecommendations: "Versorgungssystem-Empfehlungen anzeigen",
    showInterpretation: "Labor-Interpretation anzeigen",
    ...
    profileLabFlagged: "vom Labor als auffällig bewertet",
    profileNonNumericIssue: "Kein numerisch vergleichbarer Messwert · vom Labor als auffällig bewertet",
    ...
    actionPlanFor: "Für Analyse {analysis}",
    actionPlanAct: "Handeln",
    actionPlanObserve: "Beobachten",
    actionPlanActHint: "Konkrete Maßnahmen aus Laborbericht oder Versorgungssystem",
    actionPlanObserveHint: "Verläufe und Verschlechterungen ohne eigene Dosieranweisung",
    actionLabSource: "Laborbericht",
    actionSystemSource: "Versorgungssystem",
    actionProfileSource: "Besatzprofil",
    actionComparisonSource: "ICP-Vergleich",
    actionLabDose: "Laborangabe: {amount} ml · {days}",
    actionLabDoseNoDays: "Laborangabe: {amount} ml",
    actionLabOneTime: "Einmalig laut Labor: {amount} ml",
    actionLabDaily: "Täglich laut Labor: {amount} ml",
    actionWaterChange: "Wasserwechsel laut Laborbericht empfohlen.",
    actionCorrectionDose: "Gesamte Korrekturdosis: {amount} {unit}",
    actionCorrectionSplit: "Auf mindestens {days} Tage verteilen · ca. {amount} {unit}/Tag",
    actionReducePause: "Nicht zusätzlich dosieren. Zugabe vorerst reduzieren oder pausieren.",
    actionOfficialCalculator: "Für diese Korrektur den offiziellen Herstellerrechner verwenden.",
    actionRequiresIcpMs: "Vor einer Selenkorrektur ist eine geeignete ICP-MS-Analyse erforderlich.",
    actionMonitor: "Beobachten",
    actionNewIssue: "Seit der letzten ICP neu außerhalb des Sollbereichs.",
    actionWorsened: "Seit der letzten ICP weiter vom Sollbereich entfernt.",
    actionTrendUp: "Steigt seit {count} Messungen.",
    actionTrendDown: "Fällt seit {count} Messungen.",
    actionMultipleSources: "Laborbericht und Versorgungssystem geben für diesen Wert jeweils eine Maßnahme an. Dosierungen nicht addieren, sondern die Quellen getrennt prüfen.",
    actionPlanNote: "Der Maßnahmenplan bündelt vorhandene Labor-, Versorgungs-, Profil- und Vergleichshinweise. Reef ICP erzeugt dabei keine zusätzliche Dosierung.",
    actionMore: "{count} weitere Punkte werden nicht angezeigt.",
    ...
    maintenance_tropic_marin_original_balling_consumption: "Tropic Marin Original Balling besteht aus Part A, B und C. Die laufende Dosierung am Calcium-/KH-Verbrauch ausrichten; Part C dient dem Ionenausgleich. Die Lösungen getrennt dosieren. Für gezielte Ungleichgewichte erlaubt Tropic Marin unterschiedliche Mengen.",
    categories: {
  ...
  en: {
    ...
    noOdor: "No odor",
    noColor: "No coloration",
    noDeterminedMeasurements: "None of these parameters has been determined in the stored ICP history yet.",
    unknown: "Unknown",
    ...
    displaySections: "Additional sections",
    showActionPlan: "Show action plan",
    showChanges: "Show comparison with previous ICP",
    showProfileInsights: "Show stocking-profile insights",
    showLabRecommendations: "Show laboratory recommendations",
    showSupplyRecommendations: "Show supply-system recommendations",
    showInterpretation: "Show laboratory interpretation",
    ...
    profileLabFlagged: "flagged by the laboratory",
    profileNonNumericIssue: "No numerically comparable result · flagged by the laboratory",
    ...
    actionPlanFor: "For analysis {analysis}",
    actionPlanAct: "Act",
    actionPlanObserve: "Observe",
    actionPlanActHint: "Concrete actions from the laboratory report or supply system",
    actionPlanObserveHint: "Trends and worsening values without a separate dosing instruction",
    actionLabSource: "Laboratory report",
    actionSystemSource: "Supply system",
    actionProfileSource: "Stocking profile",
    actionComparisonSource: "ICP comparison",
    actionLabDose: "Laboratory instruction: {amount} ml · {days}",
    actionLabDoseNoDays: "Laboratory instruction: {amount} ml",
    actionLabOneTime: "One-time laboratory instruction: {amount} ml",
    actionLabDaily: "Daily laboratory instruction: {amount} ml",
    actionWaterChange: "Water change recommended by the laboratory report.",
    actionCorrectionDose: "Total correction dose: {amount} {unit}",
    actionCorrectionSplit: "Split across at least {days} days · approx. {amount} {unit}/day",
    actionReducePause: "Do not add more. Reduce or pause dosing for now.",
    actionOfficialCalculator: "Use the official manufacturer calculator for this correction.",
    actionRequiresIcpMs: "A suitable ICP-MS analysis is required before a selenium correction.",
    actionMonitor: "Monitor",
    actionNewIssue: "Newly outside the target range since the previous ICP.",
    actionWorsened: "Further from the target range since the previous ICP.",
    actionTrendUp: "Rising for {count} measurements.",
    actionTrendDown: "Falling for {count} measurements.",
    actionMultipleSources: "The laboratory report and supply system each provide an action for this value. Do not add the doses together; review the sources separately.",
    actionPlanNote: "The action plan groups existing laboratory, supply-system, profile and comparison guidance. Reef ICP does not create an additional dose here.",
    actionMore: "{count} additional items are not shown.",
    ...
    maintenance_tropic_marin_original_balling_consumption: "Tropic Marin Original Balling uses Parts A, B and C. Align ongoing dosing with calcium/alkalinity consumption; Part C maintains ionic balance. Dose the solutions separately. Tropic Marin allows different amounts for targeted imbalances.",
    categories: {
...
function measurementValue(measurement, language, previous = false) {
  ...
  if (normalizedRaw === "n.n." || normalizedRaw === "n.n") {
  ...
  if (
    ...
    normalizedRaw === "---" ||
    normalizedRaw === "-" ||
    (!previous && measurement?.determined === false)
  ) {
    return TEXT[language].notDetermined;
  }
  if (measurement?.key === "geruch" && normalizedRaw === "none") {
    return TEXT[language].noOdor;
  }
  if (measurement?.key === "faerbung" && normalizedRaw === "none") {
    return TEXT[language].noColor;
  }
...
function targetDefinitionLabel(target, unit, language) {
  ...
  switch (target.type) {
    case "exact":
      return `${n(target.value)}${unitLabel}`;
    case "range":
      return `${n(target.min)}–${n(target.max)}${unitLabel}`;
    case "upper_limit":
      return `< ${n(target.max)}${unitLabel}`;
    case "lower_limit":
      return `> ${n(target.min)}${unitLabel}`;
    case "not_detectable":
      return TEXT[language].notDetectable;
    case "not_determined":
      return TEXT[language].notDetermined;
...
function targetLabel(measurement, language) {
  return targetDefinitionLabel(measurement.target, measurement.unit, language);
}

function unknownKind(measurement) {
  const severity = measurement?.status?.severity || "unknown";
  if (severity !== "unknown") return null;

  const raw = String(measurement?.raw_value ?? "").trim().toLowerCase();
  if (raw === "n.n." || raw === "n.n") return "not_detectable";
  if (
    raw === "n.g." ||
    raw === "n.g" ||
    raw === "n.b." ||
...
function statusCountsFor(measurements) {
  const counts = {
    ok: 0,
    warning: 0,
    critical: 0,
  ...
  for (const measurement of measurements || []) {
    ...
    counts.unknown += 1;
    const kind = unknownKind(measurement) || "unclear";
    counts[kind] += 1;
  }
...
function personalTargetRelation(measurement) {
...
function supplySystemLabel(value, language) {
  ...
  const labels = {
    ...
    tropic_marin_original_balling: "Tropic Marin Original Balling",
  };
...
function profileIssueText(item, t) {
  if (!item?.current_issue) return "";
  if (item.target_comparable) return t.profileCurrentIssue;

  const raw = String(item.current_raw_value ?? "").trim().toLowerCase();
  if (raw === "n.n.") {
    return `${t.notDetectable} · ${t.profileLabFlagged}`;
  }
  if (raw === "n.b." || raw === "n.g." || raw === "---") {
    return `${t.notDetermined} · ${t.profileLabFlagged}`;
  }
  return t.profileNonNumericIssue;
}


function actionSourceLabel(source, t) {
  if (source === "laboratory") return t.actionLabSource;
  if (source === "supply_system") return t.actionSystemSource;
  if (source === "stocking_profile") return t.actionProfileSource;
  if (source === "comparison") return t.actionComparisonSource;
  return source || "";
}

function actionPlanActionText(action, language, t) {
  if (!action || typeof action !== "object") return "";

  if (action.source === "laboratory") {
    if (action.action === "water_change") return t.actionWaterChange;

    if (action.action === "dose") {
      if (typeof action.amount_ml === "number") {
        const amount = recommendationNumber(action.amount_ml, language, 3);
        if (action.days) {
          return interpolation(t.actionLabDose, {
            amount,
            days: `${action.days} ${action.days === 1 ? t.day : t.days}`,
          });
        }
        return interpolation(t.actionLabDoseNoDays, { amount });
      }

      if (typeof action.one_time_ml === "number") {
        return interpolation(t.actionLabOneTime, {
          amount: recommendationNumber(action.one_time_ml, language, 3),
        });
      }

      if (typeof action.daily_ml === "number") {
        return interpolation(t.actionLabDaily, {
          amount: recommendationNumber(action.daily_ml, language, 3),
        });
      }
    }
  }

  if (action.source === "supply_system") {
    if (
      action.action === "correction_dose" &&
      typeof action.dose_amount === "number"
    ) {
      return interpolation(t.actionCorrectionDose, {
        amount: recommendationNumber(action.dose_amount, language, 3),
        unit: action.dose_unit || "ml",
      });
    }
    if (action.action === "reduce_or_pause") return t.actionReducePause;
    if (action.action === "official_calculator") {
      return t.actionOfficialCalculator;
    }
    if (action.action === "requires_icp_ms") return t.actionRequiresIcpMs;
  }

  return "";
}

function actionPlanSignalText(signal, t) {
  if (!signal || typeof signal !== "object") return "";

  if (signal.source === "comparison") {
    if (signal.kind === "new_issue") return t.actionNewIssue;
    if (signal.kind === "worsened") return t.actionWorsened;
  }

  if (signal.source === "stocking_profile" && signal.trend_direction) {
    return interpolation(
      signal.trend_direction === "down"
        ? t.actionTrendDown
        : t.actionTrendUp,
      { count: signal.trend_measurement_count || 0 }
    );
  }
...
function actionPlanItemMarkup(item, language, t) {
  ...
  const actionMarkup = actions
    .map((action) => {
      const text = actionPlanActionText(action, language, t);
      const splitText =
        action.source === "supply_system" &&
        action.action === "correction_dose" &&
        action.split_days > 1 &&
        typeof action.daily_dose_amount === "number"
          ? interpolation(t.actionCorrectionSplit, {
              days: action.split_days,
              amount: recommendationNumber(
                action.daily_dose_amount,
                language,
                3
              ),
              unit: action.dose_unit || "ml",
      ...
      return `
        <div class="action-source">
          <span class="action-source-badge ${escapeHtml(
            action.source || ""
          )}">
            ${escapeHtml(actionSourceLabel(action.source, t))}
          </span>
          ${text ? `<strong>${escapeHtml(text)}</strong>` : ""}
          ${
            action.product
              ? `<span>${escapeHtml(action.product)}${
                  action.solution
                    ? ` · ${escapeHtml(action.solution)}`
                    : ""
                }</span>`
              : ""
          }
          ${splitText ? `<span>${escapeHtml(splitText)}</span>` : ""}
        </div>
      `;
    })
    .join("");
  ...
  const signalMarkup = signals
    .map((signal) => {
      const text = actionPlanSignalText(signal, t);
      if (!text) return "";
      return `
        <div class="action-signal">
          <span class="action-source-badge ${escapeHtml(
            ...
            ${escapeHtml(actionSourceLabel(signal.source, t))}
          </span>
  ...
  return `
    <div class="action-plan-item">
      ...
      ${
        actionMarkup
          ? `<div class="action-source-list">${actionMarkup}</div>`
          : ""
      }

      ${
        item.multiple_action_sources
          ? `
            <div class="action-plan-warning">
              <ha-icon icon="mdi:alert-outline"></ha-icon>
              <span>${escapeHtml(t.actionMultipleSources)}</span>
            </div>
          `
          : ""
      }
      ...
      ${
        signalMarkup
          ? `<div class="action-signal-list">${signalMarkup}</div>`
          : ""
      }
    </div>
  `;
...
class ReefIcpHistoryCard extends HTMLElement {
  constructor() {
    ...
    this._laboratoryTarget = undefined;
    this._reports = [];
    this._language = "en";
    this._points = [];
    this._requestId = 0;
  ...
  configure({ hass, measurement, reports, language }) {
    this._hass = hass;
    this._laboratoryTarget = measurement?.laboratory_target;
    this._measurement = measurement?.custom_target
      ? { ...measurement, target: measurement.custom_target }
      : measurement;
  ...
  _render() {
    ...
    const laboratoryTarget = targetDefinitionLabel(
      this._laboratoryTarget,
      this._measurement?.unit,
      this._language
    );
    const targetCaption = this._measurement?.custom_target
      ? t.personalTarget
      : t.target;
          ...
          target
            ? `
              <div class="target-hint">
                ...
                <span>${escapeHtml(targetCaption)}: ${escapeHtml(target)}</span>
              </div>
            `
            : ""
        }
        ${
          laboratoryTarget && this._measurement?.custom_target
            ? `
              <div class="target-hint laboratory-target-hint">
                <ha-icon icon="mdi:flask-outline"></ha-icon>
                <span>${escapeHtml(t.laboratoryTarget)}: ${escapeHtml(
                  laboratoryTarget
                )}</span>
              </div>
            `
...
class ReefIcpCard extends HTMLElement {
  ...
  static getConfigForm() {
    ...
    return {
      schema: [
        ...
        },
        {
          ...
          schema: [
            ...
            {
              name: "show_profile_insights",
              default: true,
              selector: { boolean: {} },
            },
            {
              name: "show_lab_recommendations",
              default: true,
              selector: { boolean: {} },
            },
            {
              name: "show_supply_recommendations",
              default: true,
              selector: { boolean: {} },
            },
            {
      ...
      computeLabel: (schema) => {
        ...
        if (schema.name === "show_action_plan") return t.showActionPlan;
        if (schema.name === "show_changes") return t.showChanges;
        if (schema.name === "show_profile_insights") {
          return t.showProfileInsights;
        }
        if (schema.name === "show_lab_recommendations") {
          return t.showLabRecommendations;
        }
        if (schema.name === "show_supply_recommendations") {
          return t.showSupplyRecommendations;
        }
        if (schema.name === "show_interpretation") {
          return t.showInterpretation;
        }
        return undefined;
      },
    };
  ...
  static getStubConfig(hass) {
    ...
    return {
      ...
      show_changes: true,
      show_profile_insights: true,
      show_lab_recommendations: true,
      show_supply_recommendations: true,
  ...
  _render() {
    ...
    const allMeasurements = Array.isArray(attrs.measurements)
      ? attrs.measurements
      : [];
    const measurements = allMeasurements.filter(
      (measurement) => measurement?.ever_determined !== false
    );
    ...
    const counts = statusCountsFor(measurements);
    ...
    const customTargetCount = measurements.filter(
      (measurement) => measurement?.custom_target?.type === "range"
    ).length;
    ...
    const supplyRecommendations =
      ...
      typeof attrs.supply_recommendations === "object"
        ? attrs.supply_recommendations
        : null;
    const supplyMaintenanceSourceUrl = safeExternalUrl(
      supplyRecommendations?.maintenance_source_url
    );
    ...
    const actionPlan =
      attrs.action_plan && typeof attrs.action_plan === "object"
        ? attrs.action_plan
        : null;
    const actionPlanItems = Array.isArray(actionPlan?.items)
      ? actionPlan.items
      : [];
    const actionPlanActionItems = Array.isArray(actionPlan?.action_items)
      ? actionPlan.action_items
      : actionPlanItems.filter((item) => item?.has_action);
    const actionPlanReviewItems = Array.isArray(actionPlan?.review_items)
      ? actionPlan.review_items
      : actionPlanItems.filter((item) => !item?.has_action);
    ...
    const profileInsightItems = Array.isArray(
      ...
      ? stockingProfileInsights.items
      : [];
    const profileContextOrder = [
      "carbonate",
      "nutrients",
      "salinity",
    ];
    const profileInsightGroups = profileContextOrder
      .map((context) => {
        const items = profileInsightItems.filter(
        ...
        return {
          context,
          items,
          attention: items.some((item) => item?.attention === "high")
            ? "high"
            : "medium",
        };
      })
    ...
    this.shadowRoot.innerHTML = `
      ...
      <ha-card>
        <div class="header">
          ...
          ${
            hasAquariumVolume || stockingProfile || supplySystem || customTargetCount
              ? `
                <div class="aquarium-profile">
                  ...
                  ${
                    customTargetCount
                      ? `
                        <span class="profile-chip custom-target-chip">
                          <ha-icon icon="mdi:target-account"></ha-icon>
                          <strong>${escapeHtml(t.customTargets)}:</strong>
                          ${escapeHtml(customTargetCount)}
                        </span>
                      `
                      : ""
                  }
        ...
        ${
          this._config.show_action_plan !== false &&
          actionPlan &&
          actionPlanItems.length
            ? `
              <details class="info-panel action-plan-panel">
                <summary class="info-summary">
                  <span class="info-icon">
                    <ha-icon icon="mdi:clipboard-check-outline"></ha-icon>
                  </span>
                  <strong>${escapeHtml(t.actionPlan)}</strong>
                  <ha-icon class="info-chevron" icon="mdi:chevron-down"></ha-icon>
                </summary>
                <div class="info-content action-plan-content">
                  <div class="recommendation-system">
                    ${escapeHtml(
                      interpolation(t.actionPlanFor, {
                        analysis: actionPlan.analysis_number || analysisNumber,
                      })
                    )}
                  </div>

                  <div class="action-plan-groups">
                    ${
                      actionPlanActionItems.length
                        ? `
                          <section class="action-plan-group">
                            <div class="action-plan-group-head">
                              <div>
                                <ha-icon icon="mdi:clipboard-check-outline"></ha-icon>
                                <strong>${escapeHtml(t.actionPlanAct)}</strong>
                                <span class="action-plan-group-count">
                                  ${actionPlanActionItems.length}
                                </span>
                              </div>
                              <small>${escapeHtml(t.actionPlanActHint)}</small>
                            </div>
                            <div class="action-plan-list">
                              ${actionPlanActionItems
                                .map((item) =>
                                  actionPlanItemMarkup(item, language, t)
                                )
                                .join("")}
                            </div>
                          </section>
                        ...
                        ? `
                          <section class="action-plan-group">
                            <div class="action-plan-group-head">
                              ...
                              <small>${escapeHtml(
                                t.actionPlanObserveHint
                              )}</small>
                            </div>
                            <div class="action-plan-list">
                              ${actionPlanReviewItems
                                .map((item) =>
                                  actionPlanItemMarkup(item, language, t)
                                )
                                .join("")}
                  ...
                  ${
                    actionPlan.items_limited
                      ? `
                        <div class="insight-more">
                          ${escapeHtml(
                            interpolation(t.actionMore, {
                              count: Math.max(
                                0,
                                Number(actionPlan.item_count || 0) -
                                  actionPlanItems.length
                              ),
                            })
                          )}
                  ...
                  <div class="recommendation-note action-plan-note">
                    <ha-icon icon="mdi:information-outline"></ha-icon>
                    <span>${escapeHtml(t.actionPlanNote)}</span>
                  </div>
                </div>
              </details>
            `
        ...
        ${
          this._config.show_changes !== false &&
        ...
        ${
          this._config.show_profile_insights !== false &&
                  ...
                  <div class="profile-group-list">
                    ${profileInsightGroups
                      .map((group) => {
                        ...
                        return `
                          <section class="profile-context-group">
                            ...
                            ${
                              reason
                                ? `
                                  <div class="profile-group-reason">
                                    ${escapeHtml(reason)}
                                  </div>
                                `
                                : ""
                            ...
                            <div class="profile-insight-list">
                              ${group.items
                                .map((item) => {
                                  ...
                                  const issueText = profileIssueText(
                                    item,
                                    t
                                  );
                                  ...
                                  return `
                                    <div class="profile-insight-item">
                                      <div class="profile-insight-head compact">
                                        <strong>${escapeHtml(
                                          item.name || item.key || "—"
                                        )}</strong>
                                        <span class="profile-insight-value">
        ...
        ${
          this._config.show_lab_recommendations !== false &&
        ...
        ${
          this._config.show_supply_recommendations !== false &&
                  ...
                  ${
                    supplyRecommendations.supported
                      ? `
                        ...
                        ${
                          supplyMaintenanceSourceUrl
                            ? `
                              <a
                                class="recommendation-source"
                                href="${escapeHtml(supplyMaintenanceSourceUrl)}"
                                target="_blank"
                                rel="noopener noreferrer"
                              >
                                <ha-icon icon="mdi:open-in-new"></ha-icon>
                                ${escapeHtml(t.openManufacturer)}
                              </a>
                            `
                            : ""
                        }
        ...
        ${
          this._config.show_interpretation !== false && interpretation
            ? `
  ...
  _categoryStatusCounts(measurements) {
    return statusCountsFor(measurements);
  }
  ...
  _categoryStatusSummary(counts, language) {
    ...
    const items = [
      ...
      ["unknown", counts.not_detectable, t.notDetectable],
      ["unknown", counts.not_determined, t.notDetermined],
      ["unknown", counts.unclear, t.otherUnclear],
  ...
  _measurementRow(measurement, language) {
    ...
    const personalTarget = targetDefinitionLabel(
      measurement.custom_target,
      measurement.unit,
      language
    );
    const laboratoryTarget = targetDefinitionLabel(
    ...
    const personalRelation = personalTargetRelation(measurement);
              ...
              personalTarget
                ? `
                  <span class="target-value">${escapeHtml(
                    t.personalTarget
                  )}: ${escapeHtml(personalTarget)}</span>
                  ${
                    laboratoryTarget
                      ? `<span class="target-value laboratory-target">${escapeHtml(
                          t.laboratoryTarget
                        )}: ${escapeHtml(laboratoryTarget)}</span>`
                      : ""
                  }
                  ${
                    personalRelation === "low" || personalRelation === "high"
                      ? `<span class="personal-target-state ${escapeHtml(
                          personalRelation
                        )}">${
                          personalRelation === "low" ? "↓" : "↑"
                        } ${escapeHtml(
                          personalRelation === "low"
                            ? t.belowPersonal
                            : t.abovePersonal
  ...
  _styles() {
    return `
      ...
      .action-plan-group + .action-plan-group {
        padding-top: 11px;
        border-top: 1px solid var(--divider-color);
      }

      .action-plan-group-head {
        display: grid;
        gap: 3px;
      }

      .action-plan-group-head > div {
        display: flex;
        align-items: center;
        gap: 6px;
      }

      .action-plan-group-head ha-icon {
        color: var(--primary-color);
        --mdc-icon-size: 16px;
      }

      .action-plan-group-head strong {
        color: var(--primary-text-color);
        font-size: 0.8rem;
      }

      .action-plan-group-head small {
        color: var(--secondary-text-color);
        font-size: 0.65rem;
        line-height: 1.35;
      }

      .action-plan-group-count {
        min-width: 18px;
        padding: 1px 5px;
        border-radius: 999px;
        color: var(--secondary-text-color);
      ...
      .action-source > strong {
        color: var(--primary-text-color);
        font-size: 0.74rem;
        line-height: 1.4;
      }

      .action-source > span:not(.action-source-badge) {
        color: var(--secondary-text-color);
        font-size: 0.68rem;
        line-height: 1.4;
      }
      ...
      .action-source-badge.laboratory {
        color: var(--primary-color);
      }

      .action-source-badge.supply_system {
        color: var(--warning-color, var(--primary-text-color));
      }
      ...
      .profile-context-group {
        ...
        background: color-mix(
          in srgb,
          var(--secondary-background-color) 52%,
          transparent
        );
      }
